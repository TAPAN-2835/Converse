...
const ThemeSelector = () => {
  ...
  return (
    <div className="dropdown dropdown-end" ref={dropdownRef}>
      ...
      <button 
        tabIndex={0} 
        className="btn btn-ghost btn-circle p-1 sm:p-2 flex items-center justify-center"
      ...
      {isOpen && (
        <div
          tabIndex={0}
          className="dropdown-content mt-2 p-1 shadow-2xl bg-base-200/95 backdrop-blur-lg rounded-2xl
